...
(def scale-ratios (r/atom (str/replace "1 80/77 12/11 8/7 96/77 10/7 16/11 120/77 12/7 20/11"
                                       #" "
                                       "\n")))
(def added-notes (r/atom "11/9
11/8
;; remove the \";;\" from line below to add an 8/5 note
;; 8/5"))

(defonce show-instructions? (r/atom false))

(defn regenerate-sketch*
...
(def sketch-state (atom (regenerate-sketch* @scale-ratios @added-notes)))
